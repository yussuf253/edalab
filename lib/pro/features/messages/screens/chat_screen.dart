...
import 'package:edalab/pro/core/models/pro_profile.dart';
import 'package:edalab/pro/core/providers/pro_auth_provider.dart';
...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  // Safely retrieve the appropriate actor user id without throwing ProviderNotFoundError
  String? _actorUserId(BuildContext context) {
    if (widget.isProView) {
      // Attempt to read ProAuthProvider; if it's not in the widget tree, return null
      try {
        return Provider.of<ProAuthProvider>(
          context,
          listen: false,
    ...
    // AuthProvider is always available in the app
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(conversation?.title ?? l10n.messagesChatFallbackTitle),
      ),
      body: _isLoading
