          ...
          children: [
                  ...
                  if (_product.badge != null)
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(_product.badge!, style: AppTextStyles.labelSmall.copyWith(color: AppColors.white)),
                      ),
                    ),
                ],
              ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  // Brand + Name
                  Text(_product.brand, style: AppTextStyles.bodySmall.copyWith(color: AppColors.primary)),
                  ...
                  Row(
                    children: [
                      ...List.generate(5, (i) => Icon(
                        i < _product.rating.floor() ? Icons.star_rounded : Icons.star_half_rounded,
                        size: 18,
                        color: AppColors.warning,
                      )),
                      const SizedBox(width: 8),
                      Text(_product.rating.toString(), style: AppTextStyles.labelLarge),
                      const SizedBox(width: 4),
                      Text('(${_product.reviewCount} reviews)', style: AppTextStyles.caption),
                      const Spacer(),
                      if (_product.inStock)
                        Container(
                  ...
                  Row(
                    ...
                    children: [
                      Text('\$${_product.price}', style: AppTextStyles.price.copyWith(fontSize: 28)),
                      const SizedBox(width: 8),
                      if (_product.originalPrice != null) ...[
                        Padding(
                          padding: const EdgeInsets.only(bottom: 4),
                          child: Text('\$${_product.originalPrice}', style: AppTextStyles.priceOld.copyWith(fontSize: 16)),
                        ),
                        const SizedBox(width: 8),
                        Container(
                          ...
                          child: Text('-${_product.discountPercent.toInt()}%', style: AppTextStyles.badge),
                        ),
                      ],
                    ],
                  ),
                  ...
                  if (_product.colors.isNotEmpty) ...[
                    ...
                    Row(
                      children: List.generate(_product.colors.length, (i) {
                        ...
                        final uicolor = _colorMap[colorName] ?? AppColors.primary;
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: _selectedColor == i ? AppColors.primary : AppColors.lightGrey,
                                width: _selectedColor == i ? 3 : 1,
                              ),
                              boxShadow: AppSpacing.shadowSm,
                            ),
                            child: _selectedColor == i && (uicolor == Colors.white || uicolor == Colors.grey.shade400)
                                ? const Icon(Icons.check, color: AppColors.dark, size: 18)
                                : _selectedColor == i ? const Icon(Icons.check, color: AppColors.white, size: 18) : null,
                          ),
                        );
                      }),
                    ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text('$_quantity', style: AppTextStyles.labelLarge),
                            ),
                            IconButton(
                  ...
                  if (_product.features.isNotEmpty) ...[
                    ...
                    const SizedBox(height: 12),
                    ..._product.features.map((f) => Padding(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text('\$${(_product.price * _quantity).toStringAsFixed(2)}', style: AppTextStyles.price),
                  ],
                ),
              ),
              Expanded(
                child: AppButton(
                  ...
                  onPressed: () {
                    ...
                    final cartItem = CartItem(
                      ...
                      quantity: _quantity,
                      moduleType: 'shopping',
                      color: _product.colors.isNotEmpty ? _product.colors[_selectedColor] : null,
                      size: _product.sizes.isNotEmpty ? _product.sizes[_selectedSize] : null,
                    );
