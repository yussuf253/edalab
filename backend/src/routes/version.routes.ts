...
router.get('/admin/version/stats', async (req: Request, res: Response) => {
...
router.post('/admin/version/update', async (req: Request, res: Response) => {
  // Add authentication middleware here
  try {
    const {
      platform,
...
router.get('/admin/versions', async (req: Request, res: Response) => {
  // Add authentication middleware here
  try {
